...
<body>
    <div class='impressum'>
        ...
        <p>Michelle Königseder <br>
            Hauptstr. 21<br>
            74391 Erligheim <br>
        </p>
        <p> <strong>Vertreten durch: </strong><br>
            Michelle Königseder<br>
        </p>
        <p><strong>Kontakt:</strong> <br>
            Telefon: 0152-1234567<br>
            E-Mail: <a href='mailto:mic.koenigseder.22@heilbronn.dhbw.de'
                id="mail">mic.koenigseder.22@heilbronn.dhbw.de</a></br></p>
